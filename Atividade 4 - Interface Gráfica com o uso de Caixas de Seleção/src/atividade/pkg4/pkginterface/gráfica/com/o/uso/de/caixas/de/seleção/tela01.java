 ...
 */
package atividade.pkg4.pkginterface.gráfica.com.o.uso.de.caixas.de.seleção;
...
public class tela01 extends javax.swing.JFrame {
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        System.out.println( nome+" possui o tipo sanguineo: " + tipoSanguineo);
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        String doador = jComboBox2.getSelectedItem().toString();
        
        if (doador == "SIM"){
            System.out.println("É doador de sangue!");
        }else{
            System.out.println("Não é doador de sangue!");
        }
